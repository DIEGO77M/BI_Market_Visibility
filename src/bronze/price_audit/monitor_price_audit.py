"""
Bronze Monitoring Script: price_audit
Author: Diego Mayorga

Purpose:
    Monitor and audit post-ingestion data quality for workspace.bronze.price_audit.
...
def run_monitoring(
    ...
    validation_table: str = "workspace.bronze.price_audit_validation",
